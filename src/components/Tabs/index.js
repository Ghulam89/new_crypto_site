        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`tw-px-4   tw-py-4 ${className} ${
              activeTab === tab.title
                ? "tw-w-full tw-text-black tw-font-zen-dots tw-text-lg  tw-bg-button-gradient tw-bg-BG"
                : " tw-border-2  tw-border-[#FFE247] tw-text-white tw-font-zen-dots border tw-w-full"
            }`}
