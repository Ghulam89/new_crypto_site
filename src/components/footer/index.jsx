      ...
      <div className="  tw-bg-[#FFE247]">
        <div className="container tw-py-8">
          <div className="row tw-items-center">
            <div className="col-md-8 tw-mx-auto md:tw-text-start  tw-text-center">
              ...
              <button className=" tw-pt-1.5 tw-bg-[#202020] tw-text-white tw-px-8 tw-py-3 m-0  tw-rounded-tr-md tw-rounded-bl-md  tw-mx-auto">GEERaff:0x33E4d3163e66B46bAbC0faF8B30C6c36DD4Ab9E9</button>
              </div>
              <p className=" sm:tw-text-xl tw-text-sm tw-text-black tw-pt-6 tw-text-center">
              Don’t hesitate to subscribe to latest news about GEERaaf Staking as well as
